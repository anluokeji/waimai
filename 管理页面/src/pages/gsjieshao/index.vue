<template>
  <el-main >
    ...
    <el-table height="1000px" :data="tableData">
      ...
      <el-table-column prop="gsm" label="公司名" width="200">
      </el-table-column>
      <el-table-column prop="gsjs" label="公司介绍" width="600">
      </el-table-column>
...
export default {
  ...
  methods:{
    ...
    dgsjs(row){
      const _this =this
      axios.delete("/company/delete/"+row.id).then(function (resp){
  ...
  created(){
    const _this = this
    axios.get("/company/select").then(function (resp){
