<template>
  <el-main >
    ...
    <el-table height="1000px" :data="tableData">
      ...
      <el-table-column prop="name" label="通知名" width="100">
      </el-table-column>
      <el-table-column prop="time"  label="通知时间" width="200">
      </el-table-column>
      <el-table-column prop="text" label="通知内容" width="600">
      </el-table-column>
...
export default {
  ...
  methods:{
    ...
    dgsjs(row){
      const _this =this
      axios.delete("/notice/delete/"+row.id).then(function (resp){
  ...
  created(){
    const _this = this
    axios.get("/notice/select").then(function (resp){
