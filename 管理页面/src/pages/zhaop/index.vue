<template>
  <el-main >
    ...
    <el-table height="1000px" :data="tableData">
      ...
      <el-table-column prop="zw" label="职位" width="100">

      </el-table-column>
      <el-table-column prop="xz" label="薪资" width="100">
      </el-table-column>
      <el-table-column prop="zwxq" label="职位详情" width="400">
      </el-table-column>
      <el-table-column prop="gznr" label="工作内容" width="500">
      </el-table-column>
...
export default {
  ...
  methods:{
    ...
    dgsjs(row){
      const _this =this
      axios.delete("/recruit/delete/"+row.id).then(function (resp){
  ...
  created(){
    const _this = this
    axios.get("/recruit/select").then(function (resp){
