<template>
  <el-main >
    ...
    <el-table height="1000px" :data="tableData">
      ...
      <el-table-column prop="title" label="新闻名" width="100">
      </el-table-column>
      <el-table-column prop="picture" label="新闻图片" width="200">
      </el-table-column>
      <el-table-column prop="text" label="新闻内容" width="600">
      </el-table-column>
...
export default {
  ...
  methods:{
    ...
    dgsjs(row){
      const _this =this
      axios.delete("/news/delete/"+row.id).then(function (resp){
  ...
  created(){
    const _this = this
    axios.get("/news/select").then(function (resp){
